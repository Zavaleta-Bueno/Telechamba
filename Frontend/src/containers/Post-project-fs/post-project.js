...
class Postprojectfsadd extends Component {
  ...
  sendDetailsToServer = () => {
    if (this.state.title.length && this.state.description.length) {
      ...
      //      this.redirectToproject();
            ...
            //  props.showError("Ocurrio un error");
      ...
      // props.showError('Por favor valide su usuario y contraseña')
  ...
  handleSubmit = (e) => {
    ...
    if (this.state.user) {
      ...
      // props.showError('Contraseña incorrecta');
  ...
  >
    ...
    <div class="form-group">
      <span class="col-md-1 col-md-offset-2 text-center">
        Describe con tus palabras el proyecto
      </span>
      <div class="col-md-8">
        <textarea
          class="form-control"
